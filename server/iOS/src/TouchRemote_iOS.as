package
{
	...
	import app.utils.NetworkUtil_iOS;
	...
	public class TouchRemote_iOS extends Sprite
	{
		...
		public function TouchRemote_iOS()
		{
			setupLogger();
		...
		private function showNetworkInfo():void
		{
			...
			if(os.lastIndexOf("ipad") >= 0 
				|| os.lastIndexOf("iphone") >= 0 
				|| os.lastIndexOf("ipod") >= 0)
			{
				networkUtil = new NetworkUtil_iOS();
			}
			else
			{
